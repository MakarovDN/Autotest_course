...
def scrabble(word):
    """
    В функции формируем словарь с количеством очков после этого в циклен перебираем слово, увеличиваем количество очков
    за каждую встреченную букву в слове.
    :param word: слово
    :return: количество очков
    """
    points = 0
    points_dict = {1: "авеёинорст",
                   2: "дклмпу",
                   3: "бгья",
                   4: "йы",
                   5: "жзхцч",
